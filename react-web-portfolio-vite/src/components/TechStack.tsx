      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
        {techStack.map((tech, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="group p-6 bg-gray-100 dark:bg-gray-800 rounded-xl flex flex-col items-center justify-center shadow-md hover:shadow-xl hover:-translate-y-1 hover:scale-105 transition duration-300 ease-in-out"
          >
            <img
              src={tech.icon}
              alt={tech.name}
